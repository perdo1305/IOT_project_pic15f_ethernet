...
# 1 "C:/Users/pedro/.mchp_packs/Microchip/PIC18F-K_DFP/1.6.125/xc8\\pic\\include/inline.h" 1 3
...
# 513 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
static void dtoa(FILE *fp, vfpf_sint_t d)
{
 ...
 int p;
    ...
    s = d < 0 ? 1 : 0;
# 533 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
    p = (0 <= prec) ? prec : 1;
...
# 552 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
    i = sizeof(dbuf) - 1;
    dbuf[i] = '\0';
    while (!(i < 1) && (d != 0
...
# 942 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
static void stoa(FILE *fp, char *s)
{
 ...
 if (!(prec < 0) && (prec < l)) {
  l = prec;
    ...
    p = l;
# 979 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
    while (p--) {
        fputc(*cp, fp);
        ++cp;
    }
# 997 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
}
...
static void utoa(FILE *fp, vfpf_uint_t d)
{
 ...
 int p;
# 1017 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
    p = (0 <= prec) ? prec : 1;
...
# 1157 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
static int
...
# 1201 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
    if ((*fmt)[0] == '%') {
        ...
        flags = width = 0;
        prec = -1;
# 1265 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
        if ((*fmt)[0] == '.') {
            ++*fmt;
...
# 1291 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
  ...
  c = *cp;
  switch(c) {
# 1308 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
   case 'l':
    cp++;
    ...
    break;
# 1335 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
   case 'u':


   case 'i':
   case 'd':
# 1350 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
    c = 'i';
    break;
   default :
    c = 0;
  ...
  if (*cp == 'd' || *cp == 'i') {
   ...
   switch (c) {
    case 'i':
     ...
     break;
# 1378 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
    case 'l':
     convarg.sint = (vfpf_sint_t)(*(long *)__va_arg(*(long **)ap, (long)0));
     break;
# 1402 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
   }
...
# 1450 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
   ...
   switch (c) {
    case 'i':
     ...
     break;
# 1469 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
    case 'l':
     convarg.uint = (vfpf_uint_t)(*(unsigned long *)__va_arg(*(unsigned long **)ap, (unsigned long)0));
     break;
# 1493 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doprnt.c"
   }
