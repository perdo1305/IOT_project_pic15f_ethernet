...
# 5 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\include\\c99/time.h" 2 3
...
# 11 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\include\\c99/time.h" 2 3
...
# 60 "mcc_generated_files/TCPIPLibrary/rtcc.c"
void rtcc_init(void)
{
    deviceTime = 1293861600;
    TMR1_SetInterruptHandler(rtcc_handler);
}
# 93 "mcc_generated_files/TCPIPLibrary/rtcc.c"
void rtcc_handler(void)
{
 deviceTime++;
}
# 124 "mcc_generated_files/TCPIPLibrary/rtcc.c"
...
# 160 "mcc_generated_files/TCPIPLibrary/rtcc.c"
time_t time(time_t *t)
{
    _Bool gie_val;
    time_t the_time;
